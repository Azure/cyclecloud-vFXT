...
Licensed under the Apache License, Version 2.0.''',
    ...
    install_requires = ['boto', 'oauth2client', 'google-api-python-client', 'requests>=2.8.0', 'azure-mgmt-compute', 'azure-mgmt-resource', 'azure-mgmt-storage', 'azure-mgmt-network', 'azure-mgmt-authorization>=0.40.0', 'azure-mgmt-msi', 'azure-storage-common', 'azure-storage-blob', 'adal', 'msrest', 'msrestazure'],
    packages=['vFXT'],
    test_suite="tests",
    scripts=['vfxt.py'],
    classifiers=[
